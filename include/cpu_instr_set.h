...
DEF_INSTR(ld_imm16mem_sp, ARG_IMM16)
...
DEF_INSTR(adc_a_r8, ARG_R8)
DEF_INSTR(sub_a_r8, ARG_R8)
DEF_INSTR(sbc_a_r8, ARG_R8)
DEF_INSTR(and_a_r8, ARG_R8)
DEF_INSTR(xor_a_r8, ARG_R8)
DEF_INSTR(or_a_r8, ARG_R8)
DEF_INSTR(cp_a_r8, ARG_R8)

// Block 3 Instructions
DEF_INSTR(add_a_imm8, ARG_IMM8)
DEF_INSTR(adc_a_imm8, ARG_IMM8)
DEF_INSTR(sub_a_imm8, ARG_IMM8)
DEF_INSTR(sbc_a_imm8, ARG_IMM8)
DEF_INSTR(and_a_imm8, ARG_IMM8)
DEF_INSTR(xor_a_imm8, ARG_IMM8)
DEF_INSTR(or_a_imm8, ARG_IMM8)
DEF_INSTR(cp_a_imm8, ARG_IMM8)

DEF_INSTR(ret_cond, ARG_COND)